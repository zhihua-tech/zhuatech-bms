...
class BmsApiIntegrationTests {
    ...
    @Test void adminCanAssessBuildingHealth() throws Exception {
        mvc.perform(post("/api/admin/building-health").with(httpBasic("admin", "admin123"))
            .contentType(MediaType.APPLICATION_JSON)
            .content("{\"energyDeviation\":14,\"criticalAlarms\":2,\"offlineDevices\":4,\"comfortRate\":84,\"maintenanceOverdue\":3}"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.data.score").value(29))
